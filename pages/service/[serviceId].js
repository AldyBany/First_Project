...
const ServiceDetail = () => {
    ...
    const serviceDetails = Data.filter(detail=>{
      return detail.title === serviceId
    })
    
  return (
    <section>
      <div className="w-full h-96 bg-blue-500 py-10 px-8 flex items-center space-x-12 justify-center">
      <div className="w-48 h-48">{serviceDetails[0]?.icon}</div>
        <h2 className="text-5xl text-center font-bold text-blue-900">{serviceId}</h2>
      </div>
      <div className="max-w-6xl mx-8 md:mx-auto py-14 grid md:grid-cols-2 gap-8">
        <div className="min-h-96 bg-gray-100 rounded-xl py-6 px-4">
          <h3 className="max-w-4xl mx-auto text-3xl font-semibold text-blue-900 mb-12">{serviceDetails[0]?.description}</h3>

          <ul className="flex flex-col space-y-6 mb-10">
            {serviceDetails[0]?.details.map(detail=>(
              <li className="text-xl font-semibold text-gray-700" key={detail.id}>{detail.name}</li>
            ))}
          </ul>

          <p className="max-w-xs px-6 py-4 bg-blue-900 text-gray-200 font-semibold rounded-md text-center shadow-2xl shadow-bleu-900/20">
        ...
        <div className="min-h-96 rounded-xl bg-orange-600"></div>
...
const Data = [
  {id:1, title:'Anti Lock Brake Servicing', description:'',details:[
  ...
  {id:3, title:'Car Wash Service', description:'',details:[
    {id:1,name:'For all vehicule models of any age, even new ones'},
    {id:2,name:'Complete with manufacturer and mobility garantee'},
    {id:3,name:'Recording of all work in service booklet'},
  ], icon:<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600"  xmlSpace="preserve" className="icon__service">
  ...
  {id:5, title:'Change Oil and Filter', description:'',details:[
    {id:1,name:'For all vehicule models of any age, even new ones'},
    {id:2,name:'Complete with manufacturer and mobility garantee'},
    {id:3,name:'Recording of all work in service booklet'},
  ], icon: <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600"  xmlSpace="preserve" className="icon__service">
  ...
  {id:6, title:'Tire Change and Repair', description:'',details:[
    {id:1,name:'For all vehicule models of any age, even new ones'},
    {id:2,name:'Complete with manufacturer and mobility garantee'},
    {id:3,name:'Recording of all work in service booklet'},
  ], icon: <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" xmlSpace="preserve" className="icon__service">
