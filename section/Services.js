...
const Services = () => {
  ...
  return (
    ...
    <h2 className="text-3xl lg:text-5xl font-bold text-[#0b0b3a] mb-8 text-center text-[#0b0b3a]">Our Services</h2>
    <p className="px-8 max-w-5xl text-center lg:text-xl text-gray-500">At Royal Car Service, we offer a full range of services for everything your car needs. Take a look at our services to find out more.</p>
        ...
        <div className=" flex flex-col space-y-4">
            {
              Data1.map(item=>(
                <p key={item.id} className="flex items-center space-x-2">
                  <span className="w-3 h-3 bg-[#0b0b3a]"></span>  <span className="text-xl bold text-[#0b0b3a]">{item.title}</span>
                </p>
              ))
            }
        </div>
...
const Data4 = [
    {id:1, title:'Anti Lock Brake Servicing', description:'Periodic car servicing is something that every responsible car owner does. But you need to know you can fully trust the skills and integrity of your chosen provider.',details:[
